...
public class RedisController {
    ...
    public void DataOfList() {
        ...
        //以下的取list值方式是通过 直接将列表的元素从左或右取出， 一旦取完，redis数据库对应的键值也会没了
    ...
    public String sendRedisMessageTest() {
        System.out.println("Sending Message..........");
        //第一个参数是，消息推送的主题名称；第二个参数是，要推送的消息信息
        //"chat"->主题
        //"我是一条消息"->要推送的消息
        stringRedisTemplate.convertAndSend("chat","我是一个推送消息");
        return "Send success";
    }
}
